...
<body bgcolor="#00abec" >
    <div id="feature">
        <div id="content">
	    <h2><a href="listAllBooks.htm">Please Click here</a></h2><h4>Jeevan</h4>
	    ...
	    <br/>
            <table width="750" frame="below">
              ...
              <%
                  ...
                  mainPageProps.add("catalina.home");
                  mainPageProps.add("jetty.base");
                  mainPageProps.add("user.timezone");
                  mainPageProps.add("java.classpath");
  ...
  out.print("</td></tr>");
              ...
              <%@ page import="java.io.*" %>
              	<%
              		...
              		out.print("<tr><td>AbsolutePath");
              		out.print("</td><td>" + new File(sbPropertyFile).getAbsolutePath());
              		out.print("</td></tr>");
		 		%>
            </table>
          </font>
